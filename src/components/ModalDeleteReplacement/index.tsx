import { deleteReplacement } from "@/services/HttpReplacement";
import { deleteInventory } from "@/services/Inventory";
import { CustomReplacement, Replacement } from "@/services/Replacement";
...
export default forwardRef(function ModalDeleteReplacement(
  ...
  async function onSubmit(e: any) {
    ...
    try {
      await deleteReplacement(idDelete)
      onDelete()
      closeModal()
    } catch (err) {
      console.log(err);
  ...
  return (
    <ModalTemplate ref={modalRef}>
      <Container>
        <h3 className="c-form__title">Deseja mesmo excluir esse pedido?</h3>
